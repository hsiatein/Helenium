use tokio::sync::mpsc;
use heleny_proto::{common_message::CommonMessage, message::{AnyMessage, Message}};
use uuid::Uuid;
...
impl Endpoint {
    pub fn new(token: Option<Uuid>, to_kernel: mpsc::Sender<Message>, service_recv: mpsc::Receiver<Message>) -> Self {
...
impl Bus {
    ...
    pub async fn send_common_message(&self, target:&'static str, payload:CommonMessage) -> Result<()> {
